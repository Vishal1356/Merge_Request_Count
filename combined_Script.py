...
def main():
    ...
    target_month = pd.Timestamp("January 2023")  # Target month to filter merge requests
    ...
    df_merge_requests = pd.DataFrame(columns=["Name", "MergeRequestCount", "LinesAdded", "LinesRemoved", "Created_at"])
...
if __name__ == "__main__":
    main()
#Updated code It is running for the particular month